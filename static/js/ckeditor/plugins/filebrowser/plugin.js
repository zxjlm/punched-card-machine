...
( function() {
	...
	function browseServer() {
		...
		//4: Remove backward compatibility (https://dev.ckeditor.com/ticket/8163).
	...
	function uploadFile() {
		...
		// If user didn't select the file, stop the fileupload.
	...
	//            fileInput The file element used during file fileupload.
	// @param {Object}
				...
				if ( url ) {
					...
					element.onClick = function( evt ) {
						...
						if ( uploadFile.call( sender, evt ) ) {
							// Use one of two fileupload strategies, either form or XHR based (#643).
 ...
 * and see the {@glink examples/fileupload example}.
 *
 *		config.filebrowserUploadUrl = '/uploader/fileupload.php';
 *
 ...
 * and see the {@glink examples/fileupload example}.
 *
 *		config.filebrowserImageUploadUrl = '/uploader/fileupload.php?type=Images';
 *
 * **Note:** This is a configuration setting for a {@glink guide/dev_file_browse_upload file browser/uploader}.
 * To configure {@glink guide/dev_file_upload uploading dropped or pasted files} use the {@link CKEDITOR.config#uploadUrl}
 ...
 * and see the {@glink examples/fileupload example}.
 *
 *		config.filebrowserFlashUploadUrl = '/uploader/fileupload.php?type=Flash';
 *
 * @since 3.0.0
 ...
 * Available values:
 *
 *	* `'xhr'` &ndash; XMLHttpRequest is used to fileupload the file. Using this option allows to set additional XHR headers with
 ...
 * Example:
 *
 *		// All browsers will use a plain form element to fileupload the file.
